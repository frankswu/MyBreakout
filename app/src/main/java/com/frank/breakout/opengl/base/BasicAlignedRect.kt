 ...
 */
open class BasicAlignedRect : BaseRect() {/*
    ...
    fun setColor(r: Float, g: Float, b: Float) {
        OpenGLUtil.checkGlError("setColor start")
        color[0] = r
        color[1] = g
        color[2] = b
        color[3] = 1.0f
    ...
    open fun draw() {
        ...
        if (GameSurfaceRenderer.EXTRA_CHECK) OpenGLUtil.checkGlError("glUniform4fv ")
...
*/
        ...
        var sVertexBuffer: FloatBuffer = sVertexArray

        // Handles to the GL program and various components of it.
        @JvmField
        var sProgramHandle = -1

        @JvmField
        var sColorHandle = -1

        @JvmField
        var sPositionHandle = -1

        @JvmField
        var sMVPMatrixHandle = -1
